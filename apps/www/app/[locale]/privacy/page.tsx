      ...
      <div className="max-w-4xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
        <div className="prose dark:prose-invert prose-gray max-w-none">
          <ReactMarkdown
            components={{
              h1: ({ children }) => (
                <h1 className="pb-4 mb-8 text-3xl font-bold text-gray-900 border-b border-gray-200">
                  {children}
                </h1>
              ),
              h2: ({ children }) => (
...
어썸데브(이하 '회사'라 함)은 개인정보 보호법 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.

## 제1조 (개인정보의 처리 목적)

회사는 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며, 이용 목적이 변경되는 경우에는 개인정보 보호법 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.

1. 서비스 제공 및 계약 이행, 이벤트 및 행사 안내
...
- 개인정보 보호책임자
  - 성명: 최수민
  - 직책: 대표
  - 연락처: 010-4413-1261, lead@awesome.dev
...
이 개인정보처리방침은 2025-05-31부터 적용됩니다.
